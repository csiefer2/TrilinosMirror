...
template Teuchos::RCP<Intrepid2::Basis<Kokkos::HostSpace,double, double> > panzer::createIntrepid2Basis<Kokkos::HostSpace,double, double>(const std::string, int, const shards::CellTopology &);

template Teuchos::RCP<Intrepid2::Basis<Kokkos::HostSpace,double, double> > panzer::createIntrepid2Basis<Kokkos::HostSpace,double, double>(const std::string, int, const Teuchos::RCP<const shards::CellTopology> &);
