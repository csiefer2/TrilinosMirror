...
PermutationScoreType lossMinimizationBlockPermutation(
  ...
  auto [ordering, obj_f] =
      impl::compute_min_ordering(communicator, settings.maxHeuristicWalltime, blockNorms,
                                 settings.gsUseUpperTriangle, objective_function, Teuchos::null);
